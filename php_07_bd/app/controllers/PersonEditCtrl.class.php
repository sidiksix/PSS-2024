...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$this->form->phone_number = getFromRequest('phone_number',true,'Błędne wywołanie aplikacji');
		...
		if (strlen($this->form->phone_number) !== 9 || !ctype_digit($this->form->phone_number)) {
			getMessages()->addError('Zły format numeru telefonu. Przykład: 606444331');
		}
